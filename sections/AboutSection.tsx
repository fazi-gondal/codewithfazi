        ...
        <RoughNotationGroup>
          ...
          <div className="md:grid grid-rows-5 lg:grid-rows-6 grid-cols-5">
              ...
              <div className="relative w-72">
                ...
                <div className="profile-picture overflow-hidden md:overflow-visible rounded-md md:shadow-2xl">
                  <Image
                    ...
                    height={1790}
                    priority
                    alt="Code With Fazi profile picture"
            ...
            <p className="col-start-1 col-end-3 row-start-4 row-end-6 lg:row-start-1 lg:row-end-2 lg:col-start-3 lg:col-end-6 lg:ml-8 lg:mt-auto about-intro">
              With 2 years of comprehensive experience in web and app
              development, I have honed my skills in both frontend and backend
              development. In addition to my hands-on experience in web and app
              development, my skills has also played a critical role in
...
const educationInfo = [
  ...
  },
  {
    ...
    subTitle: "Code With Harry & Thapa Technical | 2021",
    list: ["Full-Stack Web and App Development In React & ReactNative"],
  },
];
