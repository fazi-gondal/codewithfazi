    ...
    >
      ...
      <div className="lg:basis-2/3 z-10 relative">
        ...
        <div className="mt-2 my-4 md:mb-8">
          ...
          <p>
            With my expertise in React,ReactNative and NextJS on the frontend, and Strapi cms,
            Sanity cms, NodeJS, and Express on the backend, I bring a unique
            combination of technical skills and creative problem-solving to
            every project I work on.
          </p>
        </div>
        <LinkButton href={`https://wa.me/message/5IWKM7B67T4KE1`}>
          Chat on WhatsApp!
        </LinkButton>
      </div>
      <a
