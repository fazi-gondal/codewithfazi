...
const AppHead: React.FC<Props> = ({
  ...
  let appOgImage = `${process.env.NEXT_PUBLIC_URL}/codewithfazi-blog-og.png`;
  let appOgImageAlt = "Code With Fazi Blog";
